...
INSERT INTO user (id, name, email, password) values (1, 'Administrador', 'admin@algamoney.com', '{bcrypt}$2a$10$X607ZPhQ4EgGNaYKt3n4SONjIv9zc.VMWdEuhCuba7oLAL5IvcL5.');
INSERT INTO user (id, name, email, password) values (2, 'Maria Silva', 'maria@algamoney.com', '{bcrypt}$2a$10$Zc3w6HyuPOPXamaMhh.PQOXvDnEsadztbfi6/RyZWJDzimE8WQjaq');
...
INSERT INTO permission (id, description) values (6, 'ROLE_CREATE_ENTRY');
